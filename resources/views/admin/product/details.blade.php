                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="mt-4 mt-xl-3">
                                    <a href="#" class="text-primary">{{$result->category_name}}</a>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{gettingColorIdtoValue($result->product_color)}}

                                            <?php
                                            $colors = json_decode($result->product_color);
                                            if ($colors != null) {
                                                /*foreach ($colors as $color) {
                                                    echo gettingColorIdtoValue($color);
                                                    echo " , ";
                                                }*/
                                            }
                                            ?>
                                            {{--{{$result->product_color}}--}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="row" style="width: 400px;">Certification</th>
                                        <td><img src="{{$result->certification}}" class="img-thumbnail" width="100px">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Age</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{getGenderFromId($result->gender)}}</td>
                                    </tr>
