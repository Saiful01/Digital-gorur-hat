                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        @foreach($results as $result)
                            ...
                            <tr>
                                ...
                                <td>{{$result->url}}</td>
                                <td><img src="/images/promotional_slider/{{$result->slider_image}}" width="50px"/></td>
                                ...
                                <td>
                                    <div class="btn-group mr-1 mt-2">
                                        ...
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="/admin/promotional-slider/edit/{{$result->promotional_slider_id}}">Edit</a>
                                            <a class="dropdown-item" href="/admin/promotional-slider/delete/{{$result->promotional_slider_id}}">Delete</a>
                                        </div>
                                    </div>
