                ...
                <div class="card-body">
                    ...
                    <form action="/admin/slider/store" method="post"
                        ...
                        <div class="form-group row mb-4">
                            <label for="slider_title" class="col-sm-3 col-form-label">Slider Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row mb-4">
                            <label for="slider_sub_title" class="col-sm-3 col-form-label">Slider Sub Title</label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" id="slider_sub_title" name="slider_sub_title"></textarea>
                            </div>
                        </div>
