...
@section('content')
    ...
    <p ng-init="mySearch('','<?php echo $shop_id?>')"></p>
    <div class="container">
        <div class="row mx-auto">
            <div class="col-md-12 card">
                <div class="row ">
                    <div class="col-md-2">
                        <img class="img-thumbnail float-left mt-2 mb-2 " src="{{$my_shop->shop_image}}" width="100%"
                             height="100%"
                             alt="Shop">

                    </div>
                    <div class="col-md-4">
                        <h4 class="card-title mt-4">{{$my_shop->shop_name}}</h4>
                        <h6 class="card-title ">{{$my_shop->shop_address}}</h6>
                        <h6 class="card-title ">{{$my_shop->shop_phone}}</h6>
                    </div>
                            ...
                            <div class="collection-collapse-block open">
                                ...
                                <div class="collection-collapse-block-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="min_price" placeholder="Max"
